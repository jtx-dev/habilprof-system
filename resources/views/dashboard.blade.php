    ...
    <div class="min-h-screen">
        ...
        <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <a href="{{ route('sincronizacion') }}" class="block bg-white overflow-hidden shadow-sm sm:rounded-lg hover:shadow-md transition-shadow">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <h3 class="text-lg font-medium text-gray-900">Sincronización</h3>
                                <p class="text-sm text-gray-500">Cargar datos desde sistemas UCSC</p>
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="mt-8 bg-white p-6 rounded-lg shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <a href="{{ route('sincronizacion') }}" class="bg-blue-50 hover:bg-blue-100 p-4 rounded-lg text-center transition-colors">
                        <div class="text-blue-600 font-semibold">Sincronizar Ahora</div>
                        <div class="text-sm text-blue-500 mt-1">Actualizar datos UCSC</div>
                    </a>
